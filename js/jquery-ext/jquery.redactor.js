    ...
    (function($){
        ...
        var Redactor = function(element, options)
        {
            ...
            this.opts = $.extend({
                ...
                // CHANGED: Added script tags to allowed tags
                allowedTags: ["form", "input", "button", "select", "option", "datalist", "output", "textarea", "fieldset", "legend",
                        ...
                        "big", "pre", "code", "figure", "figcaption", "script", "strong", "em", "table", "tr", "td",
                ...
                buttonsCustom: {},
                buttonsAdd: [],
                buttons: ['html', '|', 'undo', 'redo', 'formatting', '|', 'bold', 'italic', 'deleted', '|', 'unorderedlist', 'orderedlist', 'outdent', 'indent', '|',
                        'image', 'video', 'file', 'table', 'link', '|',
                        'fontcolor', 'backcolor', '|', 'alignment', '|', 'horizontalrule', 'alignleft', 'aligncenter', 'alignright', 'justify'], // 'underline'

                airButtons: ['undo', 'redo', 'formatting', '|', 'bold', 'italic', 'deleted', '|', 'unorderedlist', 'orderedlist', 'outdent', 'indent', '|', 'fontcolor', 'backcolor'],
